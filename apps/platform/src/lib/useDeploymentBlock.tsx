...
//
//         const currentCode = await publicClient.getBytecode({
...
//
//         let lowerBound = 0;
//         let upperBound = Number(currentBlockNumber);
//         let deployedBlockNumber: number | null = null;
//
//         const maxIterations = Math.ceil(Math.log2(Number(currentBlockNumber)));
